...
#include <cmath>      // incluir cmath PRIMERO para que defina NOMINMAX 1

#undef NOMINMAX       // undefinir el NOMINMAX 1 de os_defines.h
#define NOMINMAX      // redefinir sin valor, como espera DirectXMath
